...
{
    if((op1.no1 == op2.no1) && (op1.no2 == op2.no2))
    {
        return true;
    }
    else
...
int main()
{
    ...
    // ret = obj1.+(obj2);      // as a member
    // ret = +(&obj1,obj2);     // as a friend
    ...
    // ret = -(obj1,obj2);  as friend function
    ...
    {
        cout<<"Objects are indetical\n";
    }
    else
    {
        cout<<"Objects are not identical\n";
    }
